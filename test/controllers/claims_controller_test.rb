...
class ClaimsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create claim" do
    assert_difference("Claim.count") do
      post claims_url, params: {claim: {claim_description: @claim.claim_description, claim_number: @claim.claim_number, municipality_id: @claim.municipality_id, status: @claim.status}}
    end
  ...
  test "should update claim" do
    patch claim_url(@claim), params: {claim: {claim_description: @claim.claim_description, claim_number: @claim.claim_number, municipality_id: @claim.municipality_id, status: @claim.status}}
